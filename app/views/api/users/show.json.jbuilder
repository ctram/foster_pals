...
json.extract! @user, :id, :name, :org_name, :first_name, :last_name, :email, :street_address, :city, :state, :zip_code, :about_info, :role, :main_image_thumb_url
...
json.animals_as_fosterer @user.animals_as_fosterer do |animal|
  json.extract! animal, :stays, :fosterer_id, :name, :color, :weight, :species, :sex, :breed, :main_image_thumb_url, :main_image_url, :org_id, :id
end
